...
#define LDKThemeColor RGB(249, 103, 80)        // TabBar选中颜色
#define LDKLabelColorWhite RGB(255, 255, 255)           // 字体颜色：白色
...
+ (void)showStats:(NSString *)stats atView:(UIView *)view {
    ...
    message.textColor = LDKLabelColorWhite;
    ...
    CGSize size = [stats boundingRectWithSize:CGSizeMake(MAXFLOAT, 50)
                                   ...
                                   attributes:@{NSFontAttributeName : [UIFont systemFontOfSize:15]}
                                      context:nil].size;
    message.frame = CGRectMake(0, 0, size.width + 50, size.height + 40);
...
- (void)setAttributeTextWithString:(NSString *)string range:(NSRange)range {
    ...
    [attrsString addAttribute:NSForegroundColorAttributeName value:LDKThemeColor range:range];
